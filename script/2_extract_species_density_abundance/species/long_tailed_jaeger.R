...
long_tailed_jaeger <- ltja_density %>% 
  dplyr::mutate(zone= "study area",
                ind_density_km2= (ind_density_km2*mesic_area_study_area)/study_area[study_area$zone=="study area",]$area_km2, breeding_status= "breeding", method= "nest sampling (extrapolation habitat)", spatial_extrapolation= "yes") %>% 
