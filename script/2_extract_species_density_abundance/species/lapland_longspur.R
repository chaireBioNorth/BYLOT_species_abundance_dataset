#Title: Extract the abundance of Lapland longpsurs on the Bylot Island study area 
...
lapland_longspur<- spatial_extrapolation_species_density(
  nest_data= nest_data,
  ...
  dplyr::mutate(breeding_status= "breeding", method= "nest sampling (extrapolation transects)", year= NA, spatial_extrapolation= "yes") %>% 
